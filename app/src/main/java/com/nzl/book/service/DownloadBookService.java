...
import com.nzl.book.api.support.DownloadMessage;
import com.nzl.book.api.support.DownloadProgress;
...
public class DownloadBookService extends Service {
    ...
    public void onCreate() {
        ...
        bookApi = ReaderApplication.getInstance().getAppComponent().getReaderApi();
    }
